...
class LucasAndRubenTest:
    ...
    def process(self, inframe, outframe):
        ...
        # Write a title:
        # cv2.putText(outimg, "JeVois LucasAndRubenTest", (3, 20), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255,255,255))
        ...
        outimg = gray
        if True:
            cv2.imwrite("/jevois/data/test/img{}.png".format(datetime.now()), outimg)
            self.counter += 1
        jevois.LINFO("test")
